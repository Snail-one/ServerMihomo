...
When the "本地安装" menu option runs, every file in `resources/mihomo/` is copied directly into the Linux mihomo data directory:

- Linux: `/opt/mihomo`

For example, `resources/mihomo/metacubexd/index.html` will be released as `/opt/mihomo/metacubexd/index.html`, and the bundled Linux package will be extracted as `/opt/mihomo/mihomo`.
